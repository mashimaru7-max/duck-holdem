...
export function startHand(room:Room,random=Math.random){
  if(room.players.length<2)throw new Error('게임 시작에는 2명 이상이 필요합니다.');
